...
function Dashboard() {
  ...
  const {data: comments=[]} = useGetCommentsQuery(); // Fetch comments
  const {data: users={}} = useGetUserQuery(); // Fetch users
    ...
    <>
      ...
      <div className='space-y-6'>
        <div className='bg-bgPrimary p-5'>
          ...
          <p>Here you can manage your blog's post, manage comments.</p>
        </div>
